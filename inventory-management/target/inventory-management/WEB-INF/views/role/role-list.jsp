								...
								<div class="col-md-7 col-sm-7 col-xs-12 form-group pull-right top_search">
									<div class="input-group">
										<input type="text" class="form-control" value="${roleName}"
											placeholder="Enter role name..."> <span
											class="input-group-btn">
											<a href="#" id="btnSearch" class="btn btn-default"><i class="fa fa-search"></i>Search</a>
											<a href="${pageContext.request.contextPath}/role/list" class="btn btn-default"><i class="fa fa-arrow-left"></i>Back</a>
										</span>
									</div>
								</div>
							</form>
							...
							<tbody>
								<c:forEach items="${roles}" var="role" varStatus="loop">
									...
									<td class="text-center"><a
										href="${pageContext.request.contextPath}/role/view/${role.roleId}"
									...
									<td class="text-center"><a
										href="${pageContext.request.contextPath}/role/delete/${role.roleId}"
										class="btn btn-round btn-danger"
										onclick="if (!(confirm('Are you sure you want to delete this role ?'))) return false"><i
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#btnSearch").click(function() {
			...
			$(this).attr("href", "${pageContext.request.contextPath}/role/search/1/"+roleName);
		...
		$(document).on("click", ".page-item", function() { 
			...
			if(name == "") {
				$(this).find("a").attr("href", "${pageContext.request.contextPath}/role/list/"+currentPage);
			} else {
				$(this).find("a").attr("href", "${pageContext.request.contextPath}/role/search/"+currentPage+"/"+roleName);
			}

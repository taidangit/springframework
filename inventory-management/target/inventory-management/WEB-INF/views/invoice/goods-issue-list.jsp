	...
	<div class="">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
								...
								<div class="col-md-7 col-sm-7 col-xs-12 form-group pull-right top_search">
									<div class="input-group">
										<input type="text" class="form-control" value="${productName}"
											...
											<a href="${pageContext.request.contextPath}/goods-issue/list" id="btnSearch" class="btn btn-default"><i class="fa fa-arrow-left"></i>Back</a>
										</span>
									</div>
								</div>
							</form>
				...
				<div class="x_content">
					<a href="${pageContext.request.contextPath}/goods-issue/add"
						class="btn btn-app"><i class="fa fa-plus"></i>Add</a>

					<a href="${pageContext.request.contextPath}/goods-issue/export" 
						...
						<table class="table table-striped jambo_table bulk_action">
							...
							<tbody>
								<c:forEach items="${invoices}" var="invoice" varStatus="loop">
									...
									<td class="text-center">${invoice.updateDate}</td>
									<td class="text-center"><a
										href="${pageContext.request.contextPath}/goods-issue/view/${invoice.invoiceId}"
										class="btn btn-round btn-success"><i class="fa fa-check"></i>View</a>
									</td>
									<td class="text-center"><a
										href="${pageContext.request.contextPath}/goods-issue/edit/${invoice.invoiceId}"
										class="btn btn-round btn-primary"><i class="fa fa-pencil"></i>Edit</a>
									</td>
									<td class="text-center"><a
										href="${pageContext.request.contextPath}/goods-issue/delete/${invoice.invoiceId}"
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#btnSearch").click(function() {
			...
			$(this).attr("href", "${pageContext.request.contextPath}/goods-issue/search/1/"+productName);
		...
		$(document).on("click", ".page-item", function() { 
			...
			if(invoiceName == "") {
				$(this).find("a").attr("href", "${pageContext.request.contextPath}/goods-issue/list/"+currentPage);
			} else {
				$(this).find("a").attr("href", "${pageContext.request.contextPath}/goods-issue/search/"+currentPage+"/"+productName);
			}

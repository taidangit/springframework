    ...
    <div class="container">
        ...
        <security:authorize access="hasRole('ADMIN')">
            <a href="${pageContext.request.contextPath}/admin/productInventory"
               class="btn btn-primary"><i class="fa fa-long-arrow-left"></i>Back to product inventory</a>

        </security:authorize>

        <security:authorize access="hasRole('USER')">
            <a href="${pageContext.request.contextPath}/product/list"
               class="btn btn-primary"><i class="fa fa-long-arrow-left"></i>Back to product list</a>
